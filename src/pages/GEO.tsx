...
const GEO = () => {
  return (
    <div>
      <Seo title='GEO — Generative Engine Optimization | LeapUX' description='Get found by AI. LeapUX\'s GEO service audits, monitors, and optimizes your presence across ChatGPT, Gemini, Perplexity, and Google AI.' path='/geo' />
      {/* Hero */}
